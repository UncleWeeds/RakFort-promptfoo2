  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-b border-gray-300 dark:border-white/10 relative flex items-center justify-between w-full">
        {isOpen ? (
          <h2 className="text-sm font-semibold text-gray-900 dark:text-white text-center w-full">
      ...
      {/* Tabs Section */}
      <div className="flex-1 overflow-y-auto divide-y divide-gray-200 dark:divide-white/10 w-full">
